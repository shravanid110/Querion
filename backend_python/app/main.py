...
from app.monitoring.routers import monitor_ws
...
app.include_router(monitor_ws.router, tags=["monitoring"])
...
async def custom_404_handler(request: Request, exc):
    print(f"[404] Route not found: {request.method} {request.url.path}")
    return JSONResponse(
        status_code=404,
