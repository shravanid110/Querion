...
function ConnectionPage() {
    ...
    const handleTestConnection = async ()=>{
        ...
        setErrorMessage('');
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["testConnection"])({
                ...formData,
    ...
    const handleSaveConnection = async ()=>{
        setIsSaving(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveConnection"])({
                ...formData,
                port: Number(formData.port)
            });
...
_s(ConnectionPage, "VOo8J05yJAl9necKZT85ffRMGbE=", false, function() {
    return [
...
//# sourceMappingURL=frontend_493b1fd2._.js.map